...
import { SucheFahrzeugComponent } from './suche-fahrzeuge.component';
...
// SucheBuecherModule ist ein "FeatureModule", das Features fuer die Suche nach
// Buecher bereitstellt
@NgModule({
    imports: [SharedModule, SuchformularModule],
    declarations: [SucheFahrzeugComponent],
    providers: [Title],
})
